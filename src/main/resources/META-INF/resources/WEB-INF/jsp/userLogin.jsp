...
<head>
    ...
    <title>Login | ConcordiaEats </title>
</head>
<body style="background-color: #F2CD5C;">
...
<div class="container my-3">
    <div style="margin-top: 50px;">
        <a class="navbar-brand" href="/index" style="height: auto;"> <img
                ...
                width="auto" height="70" class="d-inline-block align-top" alt=""/>
        </a><br>
    <br><br> 
    </div>
        <div class="col-sm-6" >
            ...
            <form action="userloginvalidate" method="post">
                ...
                <input type="submit" value="Login" class="btn btn-primary btn-block" style="border: 3px solid #91263A; background: #91263A">
