...
<nav style="background-color: #F2CD5C; text-align: center" class="navbar navbar-expand-lg navbar-dark">
    <div class="container-fluid">
        <div>
            <a class="navbar-brand" href="/index" style="height: auto;"> <img
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent" style="justify-content: right;">
            <ul class="navbar-nav">
                ...
                <li class="nav-item active" style="margin: auto;"><a class="nav-link" href="/search" style="color: #91263A;">
                    <div>
                        <img src="../images/Search_icon.png" width="auto" height="40"
                             alt="">
                        <div><strong>Search</strong></div>
                    </div>
                </a></li>
                <li class="nav-item active"><a class="nav-link" href="/products" style="color: #91263A;">
                    <div><img
                            th:src="@{/images/Products_icon.png}" src="/images/Products_icon.png"
                            width="auto" height="40" class="d-inline-block align-top" alt=""/>
                        <div><strong>Products</strong></div>
                    </div>
                </a></li>
                <li class="nav-item active"><a class="nav-link" href="/basket" style="color: #91263A;">
                    <div><img
                            th:src="@{/images/logo.png}" src="../images/shopping_bag.png"
