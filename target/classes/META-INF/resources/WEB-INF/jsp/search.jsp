...
<head>
    ...
    <title>Search | ConcordiaEats </title>
        ...
        <div class="row">
            <div class="col-md-6">
                    <div class="input-group">
                        <input type="text" class="form-control" name="query" value="${param.query}" placeholder="Search products">
                ...
                <div class="form-group">
                    <select class="form-control" id="category-select" name="category">
                        ...
                        <c:forEach items = "${categories}" var = "category">
                            <option value="${category.getName()}" ${category.getName() == param.category ? 'selected' : ''}>${category.getName()}</option>
                        </c:forEach>
                    </select>
                </div>
            </div>
