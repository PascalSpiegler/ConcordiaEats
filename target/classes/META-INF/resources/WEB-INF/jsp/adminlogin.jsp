...
<head>
    ...
    <title>Admin Login | ConcordiaEats </title>
</head>
<body class="bg-dark" style="background-color: #F2CD5C !important;">
...
<div class="container my-5" style="width: 1800px;" ><br>
        ...
        <div class="jumbotron border col-sm-5 mx-auto">
            ...
            <form action="loginvalidate" method="post">
                ...
                <input type="submit" value="Login" class="btn btn-primary btn-block" style="background-color: #91263A;border-color: #91263A;">
